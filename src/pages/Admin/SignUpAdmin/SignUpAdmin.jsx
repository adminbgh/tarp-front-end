...
function ModalSignUp({ changeModalLogin, showSignUp, signUpError, signUpForm, handleCloseSignUp, handleSingUp, onChangeSignUp }) {
  return (
    <Modal className="NavBar_Modal" animation show={showSignUp} onHide={handleCloseSignUp} backdrop="static" keyboard={false} size="xl" centered>
      ...
      <Modal.Body>
        <Form onSubmit={(e) => handleSingUp(e)}>
          ...
          <Button disabled={signUpForm.name.length > 3 ? (signUpForm.password.length > 9 ? !(signUpForm.email.length > 5) : true) : true} className="ButtonRegister" type="submit">

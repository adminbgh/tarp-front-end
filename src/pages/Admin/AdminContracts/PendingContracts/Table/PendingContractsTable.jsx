...
import "./PendingContractsTable.css"
import { Image, ProgressBar } from "react-bootstrap"
import { BsThreeDotsVertical } from "react-icons/bs"
import { useDispatch } from "react-redux"
import { formatNumbers } from "../../../../../services/formatNumbers"
import { adminGetOneAnalysis, adminGetSimilarContracts, adminUnCheckScam, adminMarkScam, adminGetListContract, adminDeleteCompleteContract } from "../../../../../store/actions/adminActions"
...
function PendingContractsTable({ name, scam, img, marketCap, difVolume, segurityPoints, num, setShowModal, address, setContractAddress }) {
  const dispatch = useDispatch()
  const [disabledButtom, setDisabledButtom] = useState(false)

  const handleShow = async () => {
    setDisabledButtom(true)
    await dispatch(searchBuyAndSell(address))
  ...
  return (
    <tr>
      ...
      <td>
        <div>
          <Image
            src={img === "https://ethplorer.io/undefined" ? gradientImg : img || "https://www.publicdomainpictures.net/pictures/280000/nahled/not-found-image-15383864787lu.jpg"}
      ...
      <td>
        <div className="ProgressBar_Center">
          ...
          <ProgressBar variant={segurityPoints < 40 ? "dange	r" : segurityPoints < 70 ? "warning" : "success"} now={segurityPoints} />
        </div>
      </td>
      <td>
        <div className="PendingContractsTable_Td_ButtonCheck">
